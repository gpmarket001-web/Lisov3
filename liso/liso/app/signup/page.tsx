  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "var(--color-cream)" }}>
      <div className="w-full max-w-md">
        ...
        <form action={action} className="rounded-[var(--radius-xl2)] bg-white border border-[var(--color-cream-deep)] p-8 shadow-xl">
          ...
          <div className="mt-6 space-y-3">
            <input name="clinica" required placeholder="Nome da clínica" className="w-full rounded-xl border border-[var(--color-cream-deep)] bg-[var(--color-cream)] px-4 py-3.5 text-sm" />
            <input name="email" type="email" required placeholder="Seu melhor e-mail" className="w-full rounded-xl border border-[var(--color-cream-deep)] bg-[var(--color-cream)] px-4 py-3.5 text-sm" />
            <input name="senha" type="password" required minLength={6} placeholder="Crie uma senha (mín. 6)" className="w-full rounded-xl border border-[var(--color-cream-deep)] bg-[var(--color-cream)] px-4 py-3.5 text-sm" />
            ...
            >
              {pending ? "Criando…" : "Criar conta e começar"} <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
